...
function DYB_List_Detail({ navigation, navigation: { goBack } }) {
  ...
  const SaveFeatures=async (A)=>{
    ...
    try {
      ...
      let different=[]
      let TypeList=[]
      List = (JSON.parse(await AsyncStorage.getItem(GLOBAL.DYBList_Details_KEY)));
  ...
  return (
    <Container style={[Styles.Backcolor]}>
      <Header colors={['#ffc2b5','#fca795','#d1583b']} StatusColor={'#ffc6bb'}  onPress={Back_navigate} Title={GLOBAL.FeatureNameDetail}/>
      {ShowMessage === true ?
...
export default DYB_List_Detail;
