...
module.exports = {
  ...
  Docdata : [
    { label: "open Folder", value: "30", Icon: "level-down" },
    { label: "Directory Info", value: "31", Icon: "open-book" },
    { label: "Auto Approval", value: "32", Icon: "cog" },
    { label: "Auto Approval List", value: "33", Icon: "text" },
  ],
  Doccategorydata : [
    { label: "open Folder", value: "34", Icon: "level-down" },
    { label: "Directory Info", value: "35", Icon: "open-book" },
    { label: "Auto Approval", value: "36", Icon: "cog" },
    { label: "Auto Approval List", value: "37", Icon: "text" },
  ],
  Docsubcategorydata : [
    { label: "open", value: "38", Icon: "level-down" },
    { label: "Info", value: "39", Icon: "info-with-circle" },
    { label: "Add Tag", value: "40", Icon: "price-tag" },
    // { label: "Favourite", value: "41", Icon: "text" },
    { label: "Download", value: "42", Icon: "arrow-down" },
    { label: "Pick Up link", value: "43", Icon: "link" },
    { label: "Change status", value: "44", Icon: "cog" },
    { label: "Upload New version", value: "45", Icon: "arrow-bold-up" },
    { label: "View More", value: "46", Icon: "circle-with-plus" },
  ],
  DocID:0,
  DocCategoryID:0,
  DocSubCategoryID:0,
